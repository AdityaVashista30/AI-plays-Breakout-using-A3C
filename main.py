...
class Params():
    def __init__(self):
        ...
        self.env_name = 'Breakout-v0' #we can  play other version by changing this line
...
optimizer = myOptimizer.SharedAdam(shared_model.parameters(), lr=params.lr) # the optimizer is also shared because it acts on the shared model
